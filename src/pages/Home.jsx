  ...
  return (
    ...
    >
      <Link to="/contact2" className="flex justify-center">
          ...
          />
          <div className="absolute inset-100 flex  items-center justify-center py-10 right-32">
        <h2 className="text-black text-2xl md:text-4xl lg:text-4xl font-bold px-20 ">Professional Wheel Alignment</h2>
        </div>
        </Link>
