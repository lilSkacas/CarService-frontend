  ...
  return (
    <div
     ...
     >
        ...
        <p className="flex items-center justify-left gap-3"><FaEnvelope /> mbgaraziukas@gmail.com</p>
      ...
      <img src="/src/assets/location.png" className="w-full max-w-4xl rounded-lg shadow-lg" />
    </div>
   </div> 
  </div>
